function initBetweenDate(){
	var currentDay= formatDate(new Date());
	 $("#betweenDate").text(currentDay+" ~ "+currentDay);
    $("#startDateParam").val(currentDay);
}


var currentFirstDate;
	function weekBetweenDate(){
	...
	function lastPeriod(){
		...
		if(periodType =="day"){
			var prevDay = getPrevDay();
			dataStr = prevDay +" ~ "+prevDay;
			urlParam = "/?startDate="+prevDay+"&reportType=0";

			$("#startDateParam").val(prevDay);
	...
	function nextPeriod(){
		...
		if(periodType =="day"){
			...
			dataStr = nextDay+" ~ "+nextDay;
			urlParam = "/?startDate="+nextDay+"&reportType=0";

			$("#startDateParam").val(nextDay);
			startDateParam = $("#startDateParam").val();
		}
